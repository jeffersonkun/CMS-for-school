    ...
    <div className="warehouse">
      ...
      <div className="warehouse__overview">
        <div className="warehouse__metric">
          ...
          <p className="warehouse__metric-value">
        ...
        <div className="warehouse__metric">
          ...
          <p className="warehouse__metric-value">
            {data?.metrics.monthlyDeliveries}
          </p>
        </div>
      </div>

      <div className="warehouse__alerts">
        {data && <LowStockAlert products={data.lowStockProducts} />}
      </div>
      ...
      {showStockMovement && (
        <div className="warehouse__modal">
          <div
            className="warehouse__modal-backdrop"
            onClick={handleCloseStockMovement}
          ></div>
          <div className="warehouse__modal-content">
            <StockMovement
              onSave={handleStockMovementComplete}
              onCancel={handleCloseStockMovement}
            />
          </div>
        </div>
      )}
