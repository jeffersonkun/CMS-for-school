    ...
    const loadProduct = async () => {
      if (productId) {
        ...
        try {
          ...
          const attributesArray = Object.entries(product.attributes).map(
            ([key, value]) => ({
              key,
        ...
        >
          <div className="product-form__row">
            <div className="product-form__group">
              ...
              />
              {errors.name && (
                <p className="product-form__error">{errors.name.message}</p>
              )}
            </div>
            ...
            <div className="product-form__group">
              ...
              <input
                ...
                type="text"
                className={`product-form__input ${
                  errors.sku ? "product-form__input--error" : ""
                }`}
                placeholder="Введите SKU"
                {...register("sku", { required: "SKU обязателен" })}
              />
              {errors.sku && (
                <p className="product-form__error">{errors.sku.message}</p>
              )}
            </div>
          </div>
          ...
          <div className="product-form__row">
            <div className="product-form__group">
              ...
              />
              {errors.price && (
                <p className="product-form__error">{errors.price.message}</p>
              )}
            </div>
            ...
            <div className="product-form__group">
              ...
              <input
                ...
                type="number"
                className={`product-form__input ${
                  errors.stock ? "product-form__input--error" : ""
                }`}
              ...
              />
              {errors.stock && (
                <p className="product-form__error">{errors.stock.message}</p>
              )}
            </div>
          </div>
          ...
          <div className="product-form__group">
            ...
            <input
              ...
              type="text"
              className={`product-form__input ${
                errors.category ? "product-form__input--error" : ""
              }`}
              placeholder="Введите категорию"
              {...register("category", { required: "Категория обязательна" })}
            />
            {errors.category && (
              <p className="product-form__error">{errors.category.message}</p>
            )}
          </div>
          ...
          <div className="product-form__attributes">
            <div className="product-form__attributes-header">
              ...
              <button
                type="button"
                className="product-form__add-attribute"
            ...
            {attributes.map((attribute, index) => (
              <div
                key={index}
                className="product-form__attribute"
              >
